        ...
        <div className="grid lg:grid-cols-2 gap-12 md:items-center">
          ...
          <div className="space-y-4 flex flex-col mt-12 md:mt-0 md:justify-end">
            ...
            <div className="flex flex-wrap gap-4 mt-8 md:mt-12">
              <button className="bg-primary text-white px-4 md:px-8 py-3 md:py-4 rounded-lg md:rounded-xl font-bold text-sm md:text-lg hover:bg-primary/75 transition-all shadow-lg hover:shadow-xl flex items-center gap-2 cursor-pointer">
